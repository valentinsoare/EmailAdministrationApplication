...
public class ProvideUserAndPasswordPage {
    ...
    public IMenu generatePage() {
        IStylizedMessage mainMessage = new HMessage(LoadingCachedObjectsFactory.loadMainMessageModern());
        mainMessage.stylizedMessageAttributes().setHeaderMessage("My Email");
